...
func (m *MockRepo) Add(arg0 context.Context, arg1 *models.Meeting) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) Describe(arg0 context.Context, arg1 uint64) (*models.Meeting, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) List(arg0 context.Context, arg1, arg2 uint64) ([]models.Meeting, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) Update(arg0 context.Context, arg1 models.Meeting) (bool, error) {
	m.ctrl.T.Helper()
