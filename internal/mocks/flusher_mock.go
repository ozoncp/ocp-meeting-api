...
// Source: github.com/ozoncp/ocp-meeting-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Meeting) []models.Meeting {
	m.ctrl.T.Helper()
