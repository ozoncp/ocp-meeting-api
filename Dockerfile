...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-meeting-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-meeting-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-meeting-api/bin/ocp-meeting-api .
RUN chown root:root ocp-meeting-api
EXPOSE 82
CMD ["./ocp-meeting-api"]